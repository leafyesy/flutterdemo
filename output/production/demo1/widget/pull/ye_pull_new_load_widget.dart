...
import 'package:flutter_demo/widget/pull/ye_refesh_sliver.dart' as yrs;
...
class YePullLoadWidget extends StatefulWidget {
  ...
  final YePullLoadWidgetControl control;
...
class _YePullLoadWidgetState extends State<YePullLoadWidget>
  ...
  final GlobalKey<yrs.CupertinoSliverRefreshControlState> sliverRefreshKey =
      GlobalKey<yrs.CupertinoSliverRefreshControlState>();
    ...
    if (widget.userIos) {
      return new NotificationListener(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              yrs.CupertinoSliverRefreshControl(
  ...
  Widget buildSimpleRefreshIndicator(
      ...
      yrs.RefreshIndicatorMode refreshState,
      double pulledExtent,
      double refreshTriggerPullDistance,
      double refreshIndicatorExtent) {
    pulledExtentFlare = pulledExtent * 0.6;
    playAuto = refreshState == yrs.RefreshIndicatorMode.refresh;
    return Align(
...
class YePullLoadWidgetControl extends ChangeNotifier {
