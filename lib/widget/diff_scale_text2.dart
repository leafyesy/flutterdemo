...
class DiffScaleText2 extends StatefulWidget {
  final String text;
  final TextStyle textStyle;

  const DiffScaleText2({Key key, this.text, this.textStyle})
      : assert(text != null),
        super(key: key);
...
class _DiffScaleTextState extends State<DiffScaleText2>
    with TickerProviderStateMixin<DiffScaleText2> {
  ...
  @override
  void didUpdateWidget(DiffScaleText2 oldWidget) {
